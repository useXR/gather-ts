...
export class FileSystem extends BaseService implements IFileSystem {
  ...
  public writeFileSync(filePath: string, data: string | Buffer, options?: IFileOperationOptions): void {
  ...
  public async readFile(filePath: string, options?: IFileOperationOptions): Promise<string> {
  ...
  public async writeFile(filePath: string, data: string | Buffer, options?: IFileOperationOptions): Promise<void> {
